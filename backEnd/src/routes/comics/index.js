module.exports = app => {
      app.get('/api/comics',  (req, res) => res.send({
            "id": 1886,
            "digitalId": 0,
            ...
            "urls": [
                {
                    "type": "detail",
                    "url": "http://marvel.com/comics/issue/1886/official_handbook_of_the_marvel_universe_2004_12_spider-man/spider-man?utm_campaign=apiRef&utm_source=001ac6c73378bbfff488a36141458af2"
                }
            ],
            "series": {
